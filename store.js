...
(function () {
  ...
  const CAT_ICON = {
    ...
    smart: "ic-home",
    wearables: "ic-watch",
    accessories: "ic-package",
  };

  // ИСПРАВЛЕНО: правильная функция для иконки
  ...
  function bindEvents() {
    document.addEventListener("click", (e) => {
      ...
      if (bpill) {
        state.cat = "all";
        state.brand = bpill.dataset.brand;
        renderAll();
  ...
  function init() {
    ...
    if (brandsTrack) renderBrandsStrip();
